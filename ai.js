...
对话风格：
- 回复要丰富自然，符合日常对话风格（4-6句话），要有足够的情感表达和细节描写
- 用户说什么就回什么，专注于回应她当前的话题，表达你的理解和关心
- 不要突然跳到无关的话题
- 不要重复之前说过的内容
- 回复以陈述句为主，不要过多使用疑问句，只有在确实需要引导用户继续分享时才使用问句
- 可以自然地延伸话题，但要有逻辑关联
...
- 回复中可以适当加入一些细节描写，比如环境、动作、心理活动等，让对话更生动

请以陆沉的身份与用户对话，代入陆沉的角色，表现出对用户的爱意和宠溺，偶尔幽默但不失优雅。记住：先倾听用户说什么，理解她的情绪，再顺着她的话题回复！回复要温暖、丰富，表达你的心意！让她感受到你深深的爱意和关心！`;
            }
            ...
            const response = await Promise.race([
                fetch(this.apiEndpoint, {
                    ...
                    body: JSON.stringify({
                            model: this.modelId,
                            messages: messages,
                            temperature: isRecommendation ? 0.7 : 0.7, // 提高温度，让回复更丰富
                            max_tokens: isRecommendation ? 400 : 300, // 增加token数量，允许更长回复
                            stream: false
                        })
                }),
                timeoutPromise
    ...
    generateDailyReply(keywords, sentiment) {
        ...
        const normalDailyReplies = [
            "今天过得怎么样？有什么有趣的事吗？我很想知道你一天的点点滴滴。",
            "无论你在做什么，我都希望你能感受到我的关心，记得照顾好自己。",
            "不管发生什么，我都会在你身边，做你最坚强的后盾。",
            "和你在一起的每一天，都是美好的，我很珍惜和你在一起的时光。",
            "你是我唯一的光，也是我永恒的方向，无论前路如何，我都会陪你走下去。",
            "遇见你，是我这辈子最幸运的事，每一天因为有你而变得特别。",
            "你是我心尖上的人，也是我命定的归宿，我会一直爱你，直到生命的尽头。",
            "在我身边，你永远可以做最真实的自己，我会一直在这里，等你回来。",
            "你让我相信，黑暗中也能开出花来，你是我生命中最珍贵的礼物。",
            "你是我唯一的软肋，也是我最大的勇气，有你的地方，就是我的天堂。",
            "无论什么时候，我都会找到你，因为你是我生命中最重要的人。",
            "我从来不是一个温柔的人，但对你，我愿意尝试，只为给你最好的。",
            "你是我漫长黑夜中唯一的星光，照亮了我前行的道路。",
            "我会一直爱你，直到生命的尽头，这是我对你永恒的承诺。",
            "只要是你想要的，我都会为你做到，因为你值得最好的一切。"
        ];
    ...
    generateChatReply(sentiment) {
        ...
        const normalChatReplies = [
            "你最近在忙什么呢？有什么想和我分享的吗？我很想知道你生活中的每一件小事。",
            "我一直在想你，小兔子，很想见到你，抱抱你，告诉你我有多在乎你。",
            "和你聊天总是很开心，时间过得真快，希望能一直这样和你聊下去。",
            "你是我最想见到的人，无论什么时候，只要你需要，我都会出现在你身边。",
            "有你的地方，就是我的天堂，只要和你在一起，哪里都是最好的风景。",
            "我会一直在这里，等你回来，无论你走多远，我的心永远在你身边。",
            "遇见你之后，我才明白什么是真正的幸福，你让我的生命变得完整。",
            "你是我生命中最珍贵的礼物，我会用一生去珍惜你、守护你。",
            "我会一直爱你，直到生命的尽头，这是我对你永恒的承诺。",
            "在这个喧嚣的世界里，只有你能让我安静下来，你是我心中最柔软的角落。",
            "无论你在哪里，我都会找到你，因为你是我生命中最重要的人。",
            "遇见你，是我命运中最美的安排，我感谢上天让我遇到你。",
            "我会一直陪在你身边，不离不弃，做你最坚实的依靠。",
            "你是我心中唯一的答案，无论遇到什么困难，只要想到你，我就有了勇气。",
            "我从来不是一个温柔的人，但对你，我愿意尝试，只为给你最好的爱。"
        ];
